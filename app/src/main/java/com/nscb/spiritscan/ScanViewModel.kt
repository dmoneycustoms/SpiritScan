...
import com.nscb.spiritscan.engines.EntityEngine
...
import com.nscb.spiritscan.entity.EntitySnap
...
class ScanViewModel(app: Application) : AndroidViewModel(app) {
    ...
    @Volatile private var visionResidual: Float = 0.01f
    ...
    private fun idle() = EntityOutput(
        ...
        EntitySnap("quiet", 0f, "Arm sensors, calibrate 8 s, then walk the property.", 0f, 0f, null, null, 0f, emptyList())
    )
}
